...
{
    public string $tableName = 'customer-table-geodta-table';
    ...
    public function header(): array
    {
        return [
            /**
             * for the time being customers are created when syncing the Paradox data with Zoho
             */

            /*
            Button::add('create_customer')
                ->slot('New Customer')
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Gst number', 'gst_number')
                ->sortable()
                ->searchable(),
            ...
            Column::make('Zoho contact id', 'zoho_contact_id')
                ->sortable()
                ->searchable(),
